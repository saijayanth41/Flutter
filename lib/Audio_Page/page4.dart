...
class _LocalAudio extends State<OnlineAudio> {
        ...
        Container(
          ...
          decoration: BoxDecoration(
            image: DecorationImage(
              image: NetworkImage(
                  'https://raw.githubusercontent.com/Pasupuleti-rajesh-babu/flutter_class/master/money_heist.jpg'),
              fit: BoxFit.cover,
            ),
...
/*
  Widget _taab(List<Widget> children) {
    return Column(
...
*/
  ...
  Widget LocalAudio() {
    return _tab([
      slider(),
      _btn('Play', () => audioCache.play('Audio/Money_Heist.mp3')),
